      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            //http://127.0.0.1:3000/api/v1/users/login => http://localhost:3000/api/v1/users/login
            data: {
              email: email,
              password: password
            }
        ...
        case 8:
          ...
          console.log(JSON.stringify(_context.t0.response.data) + " bin login in login.js"); // kommt von axios documentation
          // alert(JSON.stringify(err.response.data.message) + " bin login in login.js") // data ist data-responce
          (0, _alerts.showAlert)('error', JSON.stringify(_context.t0.response.data.message) + " bin login in login.js");
...
// first line of imports, für ältere Browser
